<?php
define('API_KEY','409789317:AAHIBITO1Rp0hgSc6PWsnBid_Hg64NLzf8M');
//----######------
...
//===========
$inch = file_get_contents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=@victoriateam&user_id=".$from_id);
    ...
    var_dump(
        makereq('editMessageText',[
            ...
            'reply_markup'=>json_encode([
                'inline_keyboard'=>[
                    [
                        ['text'=>"به کانال ما بپیوندید - Pease join to my channel",'url'=>"https://telegram.me/victoriateam"]
                    ]
                ]
            ])
        ])
    ...
    var_dump(
        makereq('editMessageText',[
            ...
            'reply_markup'=>json_encode([
                'inline_keyboard'=>[
                    [
                        ['text'=>"به کانال ما بپیوندید - Pleas join to my channel",'url'=>"https://telegram.me/victoriateam"]
                    ]
                ]
            ])
        ])
...
$token = $textmessage ;
	...
	$ok = $resultb["ok"];
		...
		file_get_contents("http://api.telegram.org/bot".$token."/setwebhook?url=https://victoriateam.ir/vic/bots/index.php");
